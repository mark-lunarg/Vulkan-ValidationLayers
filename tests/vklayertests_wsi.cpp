...
TEST_F(VkLayerTest, SwapchainMaintenance1ExtensionTestsAcquire) {
    ...
    if (scaling_capabilities.supportedPresentScaling != 0) {
        std::vector<VkPresentScalingFlagBitsEXT> scaling_flag_bits = {VK_PRESENT_SCALING_ONE_TO_ONE_BIT_EXT,
                                                                      VK_PRESENT_SCALING_ASPECT_RATIO_STRETCH_BIT_EXT,
                                                                      VK_PRESENT_SCALING_STRETCH_BIT_EXT};
        for (auto scaling_flag : scaling_flag_bits) {
    ...
    std::vector<VkPresentGravityFlagBitsEXT> gravity_flag_bits = {VK_PRESENT_GRAVITY_MIN_BIT_EXT, VK_PRESENT_GRAVITY_MAX_BIT_EXT,
                                                                  VK_PRESENT_GRAVITY_CENTERED_BIT_EXT};
    if (scaling_capabilities.supportedPresentGravityX != 0) {
        for (auto gravity_flag : gravity_flag_bits) {
    ...
    if (scaling_capabilities.supportedPresentScaling != 0) {
        std::vector<VkPresentScalingFlagBitsEXT> defined_scaling_flag_bits = {VK_PRESENT_SCALING_ONE_TO_ONE_BIT_EXT,
                                                                              VK_PRESENT_SCALING_ASPECT_RATIO_STRETCH_BIT_EXT,
                                                                              VK_PRESENT_SCALING_STRETCH_BIT_EXT};
    ...
    std::vector<VkPresentGravityFlagBitsEXT> defined_gravity_flag_bits = {
